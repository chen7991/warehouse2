        ...
        <div class="layui-side-scroll">
          ...
          <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
            ...
            <li data-name="component" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                <dd data-name="grid">
                  <a lay-href="${request.contextPath}/customer/toCoustomerList">客户管理</a>
                </dd>
                <dd data-name="button">
                  <a lay-href="${request.contextPath}/provider/toProviderManager">供应商管理</a>
                </dd>
                <dd data-name="form">
                  <a lay-href="${request.contextPath}/goods/toGoodsManager">商品管理</a>
                </dd>
              </dl>
            </li>
